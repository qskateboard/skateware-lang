...
inline std::unordered_map<std::string, std::string> getRussianTranslations() {
    return {
        ...
        { "Crowbar", "Фомка (пиздец название)" },
        { "Smoke Bottle", "Дымовая бутылка" },
        { "Black Mud", "Черная грязь" },
        ...
        { "Professor's Scale", "Весы профессора" },
        { "Orpheus", "Орфей" },
        ...
        { "Survivor on diagonal, auto-violinist triggered on ", "Выживший по диагонали, авто-скульптор активирован по " },
        ...
        { "Python not initialised", "Python не инициализирован" },
